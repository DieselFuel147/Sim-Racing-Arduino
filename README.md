...
Includes example code for combined shifter and pedals setup.

To-Do

- [ ] Add functionality to use special button combo on shifter to sleep and wake device (if possible)
